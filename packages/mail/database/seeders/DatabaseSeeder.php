...
namespace Froxlor\Mail\Database\Seeders;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Audit::log('The mail seeder classes have been seeded.');

        // call development/test fixture seeders
        if (SeedProfile::includesDevelopmentData()) {
            $this->call($this->testingSeederClasses());
            Audit::log('The ' . SeedProfile::developmentDataLabel() . ' mail seeder classes have been seeded.');
        }
    }
